// ---------- PRODUCT DATABASE ----------
    const products = [
        { id: 1, name: "Friedriceandchicken", brand:"PalaceRestaurant", price: 100.00, originalPrice: 120.00, discount: "20%", image: "images/friedriceandchicken.jpg" },
        { id: 2, name: "Bankuandtilapia", brand:"PalaceRestaurant"   , price: 100.00, originalPrice: 120.00, discount: "20%", image: "images/bankuandtilapia.jpg" },
        { id: 3, name: "Jollofandchicken", brand:"PalaceRestaurant" ,  price: 100.00, originalPrice: 120.00, discount: "20%", image: "images/jollofandchicken.jpg" },
        { id: 4, name: "Frenchfrieswithchicken",brand:"PalaceRestaurant" , price: 100.00, originalPrice: 120.00, discount: "20%", image: "images/frenchfriesandchicken.jpg" },
    ];
        ...
        products.forEach(prod => {
            ...
            card.innerHTML = `
                <div class="product-image">
                    <img src="${prod.image}" alt="${prod.name}" onerror="this.src='https://placehold.co/400x500?text=Food'">
                </div>
